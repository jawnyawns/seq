		...
		if (!node.$) {
			...
			return $author$project$Puzzle$Unknown(
				_Utils_update(
					data,
					{
						au: A3($elm_community$list_extra$List$Extra$setAt, letterIndex, _char, data.au)
					}));
		}
	});
...
var $author$project$Page$GameWithBlanks$focusNextBlank = F2(
	function (_v0, _v1) {
		var nodeIndex = _v0.a;
		var letterIndex = _v0.b;
		var puzzle = _v1.B;
		var _v2 = A2($author$project$Puzzle$lengthOfNode, nodeIndex, puzzle);
		if (!_v2.$) {
...
var $author$project$Page$GameWithAnagram$viewLetterInUnknown = F5(
		...
		if (!node.$) {
			...
			return A2(
				...
				A2(
					...
					A3($author$project$Page$GameWithAnagram$viewLetterInUnknown, toMsg, data, nodeIndex),
					unknownData.au));
		}
	});
