...
var $author$project$Main$InternalError = {$: 'InternalError'};
...
var $author$project$Puzzle$anagramFromWord = function (word) {
	return $author$project$Puzzle$Anagram(
		{
			letters: $elm$core$String$toList(word),
			word: word
		});
};
...
var $author$project$Puzzle$shuffleNode = function (node) {
	if (node.$ === 'Given') {
		...
		return function (_v1) {
			...
			A2(
				$elm$random$Random$step,
				$elm_community$random_extra$Random$List$shuffle(data.letters),
...
var $author$project$Puzzle$shuffle = function (puzzle) {
	return _Utils_update(
		puzzle,
		{
			nodes: A2($elm$core$List$map, $author$project$Puzzle$shuffleNode, puzzle.nodes)
		});
};
var $author$project$Page$Game$fromPuzzleIndex = function (puzzleIndex) {
	return A2(
		$elm$core$Maybe$map,
		function (puzzle) {
			return {puzzle: puzzle, puzzleIndex: puzzleIndex, swapStart: $elm$core$Maybe$Nothing};
		},
		A2(
			$elm$core$Maybe$map,
...
var $author$project$Main$init = function (encodedGameModel) {
	return A2(
		$elm$core$Result$withDefault,
		_Utils_Tuple2($author$project$Main$InternalError, $elm$core$Platform$Cmd$none),
		A2(
			$elm$core$Result$map,
			A2($author$project$Main$mapUpdate, $author$project$Main$Loaded, $author$project$Main$GameMsg),
		...
		if (node.$ === 'Given') {
			...
			return $author$project$Puzzle$Anagram(
				_Utils_update(
					data,
					{
						letters: A3($elm_community$list_extra$List$Extra$swapAt, startIndex, endIndex, data.letters)
					}));
		}
	});
...
var $author$project$Page$Game$swapLetters = F3(
	function (nodeIndex, letterIndex, model) {
		var _v0 = model.swapStart;
		if (_v0.$ === 'Nothing') {
			return _Utils_update(
				model,
				{
					swapStart: $elm$core$Maybe$Just(
			...
			return _Utils_eq(prevNodeIndex, nodeIndex) ? _Utils_update(
				model,
				{
					puzzle: A4($author$project$Puzzle$swapLetters, nodeIndex, prevLetterIndex, letterIndex, model.puzzle),
					swapStart: $elm$core$Maybe$Nothing
				}) : _Utils_update(
				model,
				{
					swapStart: $elm$core$Maybe$Just(
...
var $author$project$Ports$SetStorage = function (a) {
...
var $author$project$Page$Game$encode = function (model) {
...
var $author$project$Page$Game$NextPuzzle = {$: 'NextPuzzle'};
...
var $author$project$Page$Game$viewNextButton = function (toMsg) {
	return A2(
...
var $author$project$Page$Game$viewNode = F4(
...
var $author$project$Page$Oops$view = {
	body: _List_fromArray(
		[
			$elm$html$Html$text('Something went wrong... please try again later!')
		]),
	title: 'Oops'
};
var $author$project$Main$view = function (model) {
	if (model.$ === 'Loaded') {
		...
		return A2($author$project$Page$Game$view, $author$project$Main$GameMsg, gameModel);
	} else {
